 ...
 *
 * @author xintord <ar.cornette@gmail.com>
 * @param x
 * @param y
 * @param width
 * @param height
 ...
 * @constructor
 */
SlickUI.Element.PasswordField = function (x, y, width, height, maxChars) {
 ...
 * @param container
 */
SlickUI.Element.PasswordField.prototype.setContainer = function (container) {
 ...
 * parent container.
 */
SlickUI.Element.PasswordField.prototype.init = function() {
    ...
    kb.events.onKeyPress.add(function(key) {
        if(key == 'DEL') {
            this.valueScrambled = this.valueScrambled.substr(0, this.valueScrambled.length - 1);
            this.value = this.value.substr(0, this.value.length - 1);
        }
        else {
            this.value += key;
            this.valueScrambled = (this.valueScrambled + "*").substr(0, this.maxChars);
        }
        this.text.text.text = this.valueScrambled;
 ...
 */
SlickUI.Element.PasswordField.prototype.add = function (element) {
 ...
 * Setters / getters
 */
Object.defineProperty(SlickUI.Element.PasswordField.prototype, 'x', {
    get: function() {
...
Object.defineProperty(SlickUI.Element.PasswordField.prototype, 'y', {
    get: function() {
...
Object.defineProperty(SlickUI.Element.PasswordField.prototype, 'visible', {
    get: function() {
...
Object.defineProperty(SlickUI.Element.PasswordField.prototype, 'alpha', {
    get: function() {
...
Object.defineProperty(SlickUI.Element.PasswordField.prototype, 'width', {
    get: function() {
...
Object.defineProperty(SlickUI.Element.PasswordField.prototype, 'height', {
    get: function() {
